...
| Phase 2 | 위치/시간 기반 하늘 계산 + 스테레오그래픽 렌더링 | **완료** (2026-05-07) |
| Phase 3 | NASA/ESA 이미지 연동 + 별 클릭 시 실제 사진 표시 | **완료** (2026-05-07) |
| Phase 4 | GitHub Actions 자동화 + Cloudflare R2 연동 | **완료** (2026-05-07, APOD 기준) |
